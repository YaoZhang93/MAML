...
from nnunet.network_architecture.generic_MAML import Generic_MAML
...
class MAMLTrainerV2(nnUNetTrainer):
    """
    ...
    def initialize_network(self):
        ...
        self.network = Generic_MAML(self.num_input_channels, self.base_num_features//2, self.num_classes,
